  ...
  return (
    <>
      <div className='m-4 flex justify-end'>
        ...
        <input className="placeholder:italic placeholder:text-slate-400 bg-white w-1/3 border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for a product..." type="text" name="search" onChange={(e) => {setSearchTerm(e.target.value)}} />
